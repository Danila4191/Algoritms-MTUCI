      ...
      <div className={styles.cards_box}>
        <Link className={styles.link} to="/module-one">
          <div className={`${styles.card} `}>
            <p className={`${styles.link__text} text_type_h3`}>Module one
            </p>
            <p className={`${styles.link__text} text`}>Сортировка выборкой и quicksort
            </p>
          </div>
        </Link>
        ...
        <div className={`${styles.card} `}>
            <p className={`${styles.link__text} text_type_h3`}>Module three
            </p>
            <p className={`${styles.link__text} text`}>
            </p>
          </div>
        ...
        <div className={`${styles.card} `}>
            <p className={`${styles.link__text} text_type_h3`}>Module four
            </p>
            <p className={`${styles.link__text} text`}>
            </p>
          </div>
        ...
        <div className={`${styles.card} `}>
            <p className={`${styles.link__text} text_type_h3`}>Module five
            </p>
            <p className={`${styles.link__text} text`}>
            </p>
          </div>
